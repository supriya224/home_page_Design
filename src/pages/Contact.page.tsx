        ...
        <form action="https://api.web3forms.com/submit" className="mt-10">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div className="relative z-0">
              ...
              <label
                htmlFor=""
                className="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-orange-500 peer-focus:dark:text-orange-500"
              >
                Your email
              </label>
            </div>
            <div className="relative z-0 col-span-2">
              <textarea
                ...
                placeholder=" "
              />
              <label className="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-orange-500 peer-focus:dark:text-orange-500">
                Your message
              </label>
            </div>
          </div>
          <button
            type="submit"
            className="mt-5 rounded-md bg-orange-500 px-10 py-2 text-white"
          >
            Send Message
          </button>
        </form>
